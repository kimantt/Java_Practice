...
public class Operators {
	...
	public static void main(String[] args) {
		...
		//short result = -a; // short type 변수 a에 부호연사 -를 적용하면 반환 타입은 int -> short에 저장 type 오류
		...
		y1 = x1++; //++가 대입연사 이후로 밀림 x1의 값을 먼저 y1에 대입(10이 대입)시키고 x1을 1 증가 11이 됨
		...
		System.out.println(y++ + 10 );  //y를 10하고 더한후에 출력 후  y값을 1증가시킴
		System.out.println(y ); // 40라인에서 증가된 y가 출력 : 2
		...
		System.out.println(z2);// -727379968 오버플로우 발생하면서 1조를 뒤에서부터 저장하다가 모자라면 저장하지 않음
