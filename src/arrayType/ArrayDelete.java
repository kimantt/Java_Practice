...
public class ArrayDelete {
	...
	public static void main(String[] args) {
		...
		// 기존에 num이 참조하고 있던 배열(크기가 5인 배열)은 참조를 잃어버리게 됨 - 가비지콜렉터가 메모리 할당 풀어버림
		
		// num = null; // num이 참조하고 있던 배열에 대한 참조값을 지우고 null이 저장됨 - 어느 객체도 참조하고 있지 않다는 의미
		// 기존에 num이 참조하고 있던 배열(크기가 5인 배열)은 참조를 잃어버리게 됨 - 가비지콜렉터가 메모리 할당 풀어버림
